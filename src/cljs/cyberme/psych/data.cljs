  ...
  (mapv
    ...
    (let [data
          [[1 "![](https://static2.mazhangjing.com/cyber/202209/016fdea5_图片.png)" :A]
           ...
           [7 "![](https://static2.mazhangjing.com/cyber/202210/9eb4df09_图片.png)" :B]
  ...
  (mapv
    ...
    (let [data
          [[1 "![](https://static2.mazhangjing.com/cyber/202209/47601869_图片.png)" :A]
           ...
           [5 "![](https://static2.mazhangjing.com/cyber/202210/ea06af86_图片.png)" :D]
           [6 "![](https://static2.mazhangjing.com/cyber/202210/e44f7b75_图片.png)" :C]
...
(defn emotion-questions []
  {:type   :question
   :widget [questionnaire
            {:id        "情绪问卷"
             :leading   "当我在学习中收到这种反馈时，我感到：(0 完全不同意，10 完全同意)"
...
(defn motivation-questions-guo []
  {:type   :question
   :widget [questionnaire
            {:id      "动机问卷"
             :leading "请根据你刚刚在学习过程中对反馈学习的感受，仔细阅读每一项，然后根据自己的实际情况，选择相应的选项。"
             :answers ["极不符合" "不符合" "不确定" "符合" "完全符合"]
             :questions
             ["1.它激发了我的好奇心。"
              "2.它令人感兴趣。"
...
(defn meta-cong-questions []
  {:type   :question
   :widget [w/questionnaire
            {:id      "元认知问卷"
             :leading "以下是在学习数学时可能出现的一些做法或想法，请根据自己的实际情况比较你与这些做法或想法之间的相像程度，并选择最适合你的选项。"
             :questions
...
(defn adapt1-questions []
  {:type   :question
   :widget [questionnaire
            {:id      "对错误反应的适应性问卷1"
             :leading "请对以下题目中的说法,选出最符合你实际情况的数字（从 1 非常不同意到 7 非常同意）"
             :questions
...
(defn mentality-questions []
  {:type   :question
   :widget [questionnaire
            {:id      "成长心态问卷"
             :leading "请对以下题目中的说法,选出最符合你真实想法的数字。（从 1 完全不同意到 6 完全同意）"
             :questions
             ["1.你有一定的智力，但你无法真正改变它。"
              "2.你的智力是一些你无法改变的东西。"
              "3.无论你是谁，你都可以显著改变你的智力水平。"
              "4.老实说，你无法真正改变自己的聪明程度。"
              "5.你总是可以从根本上改变你的聪明程度。"
              "6.你可以学习新事物，但你不能真正改变你的基本智力。"
              "7.不管你有多聪明，你总是可以改变很多。"
              "8.你甚至可以大大改变你的基本智力水平。"]
             :answers [1 2 3 4 5 6]}]})
...
(defn interest-questions-jiang []
  {:type   :question
   :widget [w/interest-questionnaire-jiang
            {:id      "自评问卷"
             :leading "请对以下题目中的说法，选出最符合你实际情况的数字（从1最低水平到10最高水平）。"
             :questions
             ["1. 你对《二次根式》这一章节知识的掌握程度有多少？"
              "2. 你对《二次根式》这一章节内容的理解程度有多少？"
              "3. 你对《二次根式》这一章节的熟悉程度如何？"]

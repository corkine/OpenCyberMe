...
实现了位置的更新和删除（前端 UI，后端数据处理以及前端反馈更新）。

================================================
TODO:
- 主界面请求最近打包数据（提供物品上弹菜单）。
- 实现主界面的物品搜索、标签和状态。
- 实现”更新物品“功能、”物品移动到新位置“功能。
- 实现”物品标记打包“功能、”物品更新打包“功能、”物品删除打包功能“功能。
- 实现物品图片上传、预览和修改。
